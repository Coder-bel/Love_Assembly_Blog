...
const contactInfo = [
  { icon: MapPin, label: 'Address', value: '12 Grace Avenue, Lekki Phase 1, Lagos, Nigeria' },
  { icon: Phone, label: 'Phone', value: '+234 800 123 4567' },
  { icon: Mail, label: 'Email', value: 'info@loveassembly.org' },
  { icon: Clock, label: 'Service Times', value: 'Sundays 8:00 AM & 10:30 AM | Wednesdays 6:30 PM' },
];
            ...
            <div>
              ...
              <Reveal delay={300}>
                <div className="mt-8 overflow-hidden rounded-2xl shadow-md ring-1 ring-slate-100">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.587410!2d3.4749!3d6.4474!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMjYnNTAuNiJOIDPCsDI4JzI5LjYiRQ!5e0!3m2!1sen!2sng!4v1234567890"
                    width="100%"
                    height="300"
                    style={{ border: 0 }}
                    allowFullScreen
